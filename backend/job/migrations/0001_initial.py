    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('jobType', models.CharField(choices=[('Permanent', 'Permanent'), ('Temporary', 'Temporary'), ('Internship', 'Iinternship')], default='Permanent', max_length=10)),
                ('education', models.CharField(choices=[('Bachelors', 'Bachelors'), ('Masters', 'Masters'), ('Phd', 'Phd')], default='Bachelors', max_length=20)),
                ('industry', models.CharField(choices=[('Business', 'Business'), ('IT', 'It')], default='Business', max_length=20)),
                ('experience', models.CharField(choices=[('No experience', 'No Experience'), ('1 Years', 'One Year')], default='No experience', max_length=20)),
